...
void Circle :: fillBoundary(int x,int y,GLubyte* fillColor,GLubyte* boundaryColor,int type)
{
	this->fillColor = fillColor;
	filled = true;
	if(type == 1)
		fillCircle4(x,y,fillColor,boundaryColor);
	else if(type == 2)
		fillCircle8(x,y,fillColor,boundaryColor);
...
void Circle :: fillCircle4(int x,int y,GLubyte* fillColor,GLubyte* boundaryColor)
{	
	...
	if((interiorColor[0] != fillColor[0] || interiorColor[1] != fillColor[1] || interiorColor[2] != fillColor[2]) && (interiorColor[0] != boundaryColor[0] || interiorColor[1] != boundaryColor[1] || interiorColor[2] != boundaryColor[2]))
	{
		...
		glEnd();
		glFlush();
		fillCircle4(x+1,y,fillColor,boundaryColor);
		fillCircle4(x-1,y,fillColor,boundaryColor);
		fillCircle4(x,y+1,fillColor,boundaryColor);
		fillCircle4(x,y-1,fillColor,boundaryColor);
	}
}


void Circle :: fillCircle8(int x,int y,GLubyte* fillColor,GLubyte* boundaryColor)
{	
	GLubyte interiorColor[3];
	glReadPixels(x,height - y,1,1,GL_RGB,GL_UNSIGNED_BYTE,interiorColor);
	...
	if((interiorColor[0] != fillColor[0] || interiorColor[1] != fillColor[1] || interiorColor[2] != fillColor[2]) && (interiorColor[0] != boundaryColor[0] || interiorColor[1] != boundaryColor[1] || interiorColor[2] != boundaryColor[2]))
	{
		...
		fillCircle8(x+1,y+1,fillColor,boundaryColor);
		fillCircle8(x+1,y-1,fillColor,boundaryColor);
		fillCircle8(x-1,y+1,fillColor,boundaryColor);
		fillCircle8(x-1,y-1,fillColor,boundaryColor);
		
		fillCircle8(x+1,y,fillColor,boundaryColor);
		fillCircle8(x-1,y,fillColor,boundaryColor);
		fillCircle8(x,y+1,fillColor,boundaryColor);
		fillCircle8(x,y-1,fillColor,boundaryColor);
	}
}
